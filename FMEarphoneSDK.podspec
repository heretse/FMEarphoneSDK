...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FMEarphoneSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/heretse@gmail.com/FMEarphoneSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'heretse@gmail.com' => 'winston_hsieh@gemteks.com' }
  s.source           = { :git => 'https://github.com/heretse@gmail.com/FMEarphoneSDK.git', :tag => s.version.to_s }
